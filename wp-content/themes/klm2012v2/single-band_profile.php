<?php
/**
 * Template Name: Single Bannd Template
 * @package WordPress
 * @subpackage KLM2012
 */
...
get_header(); ?>
		...
		<div id="primary" class="single single-band ">
			...
			<?php /* Start the Loop */ ?>
                ...
                $genre = get_the_terms( $post->ID, 'genres' ); foreach ( $genre as $genre ) {$genre = $genre->name;}
				$band = get_the_terms( $post->ID, 'band' ); foreach ( $band as $band ) {$band = $band->name;};
                ...
                <?php 
                    ...
                    <header>
                    	<h1><?php the_title();?></h1>
                        <ul>
							<li><b>Hometown:</b> <?php echo $city; ?></li>
                            <li><b>Genre:</b> <?php echo $genre ?></li>
                        </ul>
  ...
  foreach ( $custom_field_keys as $key => $value ) {
	  ...
	  echo $values;
	  if ($value != '_edit_last' && $value != '_edit_lock' && $value != '_thumbnail_id'){
		  foreach ( $my_custom_field as $set => $link ){
            ...
            <section class="related">
                ...
                <div class="grid_6 related_posts">
                    <h3>Band News <span class="red">&gt;&gt;</span></h3>
<?php 
...
?> 
                ...
                <h3>Share This Band <span class="red">&gt;&gt;</span></h3>
