...
get_header(); ?>
		...
		<div id="primary" class="single single-band ">
			...
			<?php /* Start the Loop */ ?>
				...
				?>
                <article>
                <img src="http://klm.apt2labs.com/wp-content/uploads/2012/02/no-image.png" height="260" width"260" />
                    <header>
                    	<h1><?php the_title();?></h1>
                        <ul>
                            ...
                            <li><b>Cover:</b> <?php echo get_post_meta($post->ID, 'cover', true);?></li>
                            <li><b>Venue:</b> <?php echo $venue; ?></li>
