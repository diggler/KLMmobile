<?php
/**
 * The Top Level venue landing page.
 *
 *
 * Template Name: Page venue List Template
 * @package WordPress
 * @subpackage KLM2012
 */
	...
	<div id="primary" class="landing-bands">
            ...
            <div id="col1" class="grid_17 suffix_1">
				...
				<section class="band_list">
                    ...
                    <h3>Venues <span class="red">&gt;&gt;</span></h3>
                    
                    <div class="content">
<?php 
//Band query
query_posts('posts_per_page=-1&nopaging=true&post_type=venue_profile&order=ASC'); ?>                    
<?php 
$num_cols = 3;
if (have_posts()) :
